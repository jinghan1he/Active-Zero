...
class DataConfig:
    ...
    def post_init(self):
        ...
        self.val_format_prompt = get_abs_path(self.val_format_prompt, prompt="Format prompt file") if self.val_format_prompt else self.format_prompt
...
class TrainerConfig:
    ...
    response_path: str = "./generations_validation.jsonl"
    """path to save the generations for validation"""
